...
This is a Spring Boot 3.5 REST API project using Java 21 with Maven. This repository contains only this instruction file and the devcontainer configuration on first clone. All project files must be generated by Copilot and tested before the project is complete.
